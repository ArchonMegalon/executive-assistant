...
- Remaining real work is operator/account-side: Google reauth and accepted brief, WhatsApp QR plus
  listened audiobook, a genuine OODA packet decision, reviewed EA merge/runtime rebuild, and fresh
  exact-source release receipts. EA is still ahead 1 / behind 1 with a shared dirty worktree; do
  not claim a clean EA release.
