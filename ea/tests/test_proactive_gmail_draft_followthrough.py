...
def test_operator_status_verifier_requires_maintain_runtime_surface(tmp_path: Path) -> None:
    verifier = _load_script(VERIFY_OPERATOR_STATUS_PATH, "verify_operator_status_for_maintain_surface_test")
            ...
            "lanes": [
                {
                    ...
                    "required_event_types": ["pocket_recording_archive_indexed"] if key == "pocket_ai_audio_transcripts" else [],
                    "required_event_type_observed": True,
                    "evidence_event_types": ["pocket_recording_archive_indexed"] if key == "pocket_ai_audio_transcripts" else [],
                }
    ...
    assert "maintain_proactive_ooda_runtime requires next_action_href" in issues
    assert "maintain_proactive_ooda_runtime requires next_action_label" in issues
    assert "maintain_proactive_ooda_runtime requires next_action_method=get" in issues
