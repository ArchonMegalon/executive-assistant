...
FetchSessionSnapshotFn = Callable[[str], ExecutionSessionSnapshot | None]
ExecuteNextReadyFn = Callable[[str, str], object]
...
class ExecutionApprovalResumeService:
    def __init__(
        ...
        *,
        ...
        fetch_session: Callable[[str], ExecutionSessionSnapshot | None],
        delayed_retry_queue_item: Callable[[ExecutionSessionSnapshot], ExecutionQueueItem | None],
    ) -> None:
