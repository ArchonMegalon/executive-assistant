...
_SERVICE_DEFINITIONS: tuple[BrowserActUiServiceDefinition, ...] = (
    ...
    _template_reader_service(
        service_key="vidboard_workspace_reader",
        capability_key="vidboard_workspace_reader",
        tool_name="browseract.vidboard_workspace_reader",
        skill_key="inspect_vidboard_workspace",
        task_key="inspect_vidboard_workspace",
        name="Inspect VidBoard Workspace",
        description="Template-backed BrowserAct VidBoard workspace reader for avatar-surface inspection, export checks, and provider-proof capture.",
        deliverable_type="vidboard_workspace_packet",
        browseract_names=("BrowserAct", "VidBoard"),
        aliases=("vidboard", "vidboard_ai", "vidboard_workspace", "inspect_vidboard_workspace"),
        template_key="vidboard_workspace_reader",
        page_input_name="page_url",
    ),
    _template_reader_service(
        service_key="voicewave_workspace_reader",
        capability_key="voicewave_workspace_reader",
        tool_name="browseract.voicewave_workspace_reader",
        skill_key="inspect_voicewave_workspace",
        task_key="inspect_voicewave_workspace",
        name="Inspect VoiceWave Workspace",
        description="Template-backed BrowserAct VoiceWave workspace reader for voice generation, export, and custom-voice surface inspection.",
        deliverable_type="voicewave_workspace_packet",
        browseract_names=("BrowserAct", "VoiceWave"),
        aliases=("voicewave", "voicewave_ai", "voicewave_workspace", "inspect_voicewave_workspace"),
