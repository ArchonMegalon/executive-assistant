        ...
        "settings": {
            ...
            "cards": [
                ...
                },
                {
                    ...
                    "items": [
                        _row("Workspace plan", str(dict(diagnostics.get("plan") or {}).get("display_name") or "Pilot"), "Plan"),
                        _row("Plan unit", str(dict(diagnostics.get("plan") or {}).get("unit_of_sale") or "workspace"), "Plan"),
