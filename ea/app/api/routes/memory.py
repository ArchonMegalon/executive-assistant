...
from app.api.routes.memory_mail import router as memory_mail_router
from app.api.routes.memory_memorial import router as memory_memorial_router
...
router.include_router(memory_mail_router)
router.include_router(memory_memorial_router)
