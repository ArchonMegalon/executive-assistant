...
inspect Docker, invoke Compose or Git, read environment files, consume a
mutation permit, or write the canonical recovery journal.  Its only output is
...
PLAN_CONTRACT = "ea.memorial_api_baseline_normalization_plan.v1"
PLAN_VERSION = 1
...
AUTHORITY_KEYS = frozenset(
    {
        ...
        "joint_permit_contract",
        "journal_contract_review_required",
        "required_permit_checkpoints",
    }
)
...
PERMITTED_IDENTITY_DIFFERENCES = [
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "identity_requirements": {
            ...
            "permitted_differences": list(PERMITTED_IDENTITY_DIFFERENCES),
        ...
        "authority": {
            ...
            "joint_permit_contract": "ea.vexp_memorial_joint_mutation_permit.v1",
            "required_permit_checkpoints": list(REQUIRED_PERMIT_CHECKPOINTS),
        },
        "recovery_requirements": {
            "distinct_crash_journal_required": True,
            "normal_deploy_blocked_while_recovery_active": True,
            "permit_free_rollback_required": True,
...
def validate_plan_payload(payload: Mapping[str, Any]) -> None:
    ...
    if (
        ...
        != REQUIRED_IDENTITY_DOMAINS
        or identity.get("permitted_differences")
        != PERMITTED_IDENTITY_DIFFERENCES
        ...
        or authority.get("joint_permit_contract")
        != "ea.vexp_memorial_joint_mutation_permit.v1"
        or authority.get("required_permit_checkpoints")
        != REQUIRED_PERMIT_CHECKPOINTS
        or recovery.get("distinct_crash_journal_required") is not True
        or recovery.get("normal_deploy_blocked_while_recovery_active")
        is not True
        or recovery.get("permit_free_rollback_required") is not True
        ...
        or execution.get("permit_consumed") is not False
