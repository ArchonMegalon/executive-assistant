...
PROACTIVE_OODA_TABLES: dict[str, list[dict[str, object]]] = {
    "proactive_ooda_runs": [
        ...
        _text_field("delivery_route"),
        _text_field("approval_state"),
        _checkbox_field("user_action_required"),
        _text_field("action_required_reason"),
        _long_text_field("blockers"),
        _text_field("current_or_stale"),
        _long_text_field("resume_cursor"),
        _checkbox_field("follow_through_recorded"),
        _text_field("follow_through_status"),
        _text_field("follow_through_receipt_sha256"),
    ...
    "proactive_ooda_items": [
        ...
        _text_field("staged_link_url_sha256"),
        _text_field("staged_artifact_kind"),
        _text_field("staged_artifact_ref_sha256"),
        _text_field("approval_state"),
        _checkbox_field("user_action_required"),
        _text_field("action_required_reason"),
        _long_text_field("blockers"),
