...
def main() -> int:
    ...
    try:
        ...
        try:
            ...
            print(json.dumps({"status": "failed", "reason": f"api_unavailable:{exc.reason}", "local_error": str(local_exc)[:240]}))
            return 1
        ...
        try:
            ...
            print(json.dumps({"status": "failed", "reason": f"http_{exc.code}", "body": body[:240], "local_error": str(local_exc)[:240]}))
            return 1
