...
SELF_TEST_SCHEMA = "ea.manfred_memorial_image_build.self_test.v2"
BUILD_ROOT_FREE_HEADROOM_BYTES = 15 * 1024**3
MINIMUM_ROOT_FREE_BYTES = BUILD_ROOT_FREE_HEADROOM_BYTES
...
def _self_test() -> dict[str, object]:
    ...
    if MINIMUM_ROOT_FREE_BYTES != 15 * 1024**3:
