...
def build_skill_payload() -> dict[str, object]:
    return {
        ...
        "description": "Planner-executed BrowserAct workflow repair skill that routes repair judgment through EA with 1min-first preference and Gemini fallback when needed.",
        ...
        "memory_writes": [],
        "tags": ["browseract", "workflow", "repair", "self-heal"],
        "input_schema_json": {
            "type": "object",
        ...
        "model_policy_json": {
            "brain_profile": "repair",
            "default_model": "ea-coder-fast",
            "posthoc_review_profile": "review_light",
            "fallback_brain_profile": "survival",
            "output_mode": "json",
        },
        "provider_hints_json": {
            "primary": ["1min.AI", "BrowserAct", "Gemini Vortex"],
