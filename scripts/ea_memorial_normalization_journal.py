...
TERMINAL_RECEIPT_CONTRACT_NAME = "ea.memorial_api_baseline_normalization.v1"
...
TERMINAL_RECEIPT_PERMIT_CHECKPOINTS = (
...
def terminal_receipt_payload(
    ...
    *,
    ...
    if kind == "durable_commit":
        execution_record = {
            "mode": "forward",
            "permit_checkpoints": list(TERMINAL_RECEIPT_PERMIT_CHECKPOINTS),
            "permit_requested_during_recovery": False,
