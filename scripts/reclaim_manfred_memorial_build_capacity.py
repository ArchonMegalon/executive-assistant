...
PLAN_SCHEMA = "ea.manfred_memorial_build_capacity.plan.v2"
PLAN_PROBE_SCHEMA = "ea.manfred_memorial_build_capacity.plan_probe.v2"
ROOT_ATTEST_REQUEST_SCHEMA = (
    "ea.manfred_memorial_build_capacity.root_attest_request.v2"
)
ROOT_ATTESTATION_SCHEMA = "ea.manfred_memorial_build_capacity.root_attestation.v2"
INTENT_SCHEMA = "ea.manfred_memorial_build_capacity.intent.v2"
USER_RECEIPT_SCHEMA = "ea.manfred_memorial_build_capacity.user_receipt.v2"
ROOT_HANDOFF_SCHEMA = "ea.manfred_memorial_build_capacity.root_handoff.v2"
ROOT_RECEIPT_SCHEMA = "ea.manfred_memorial_build_capacity.root_receipt.v2"
COMPLETION_SCHEMA = "ea.manfred_memorial_build_capacity.completion.v2"
VSCODE_JOURNAL_SCHEMA = "ea.manfred_memorial_build_capacity.vscode_journal.v2"
VSCODE_COMPLETE_SCHEMA = "ea.manfred_memorial_build_capacity.vscode_complete.v2"
...
EXPECTED_CANDIDATE_RECEIPT_SHA256 = (
    "7a451b18800b107c7a1913cff39f57a96b5dd5c24dc4fcb1129ecf396e1cbf1a"
)
...
ROOT_RECEIPT_NAME = re.compile(
    r"manfred-capacity-[0-9a-z][0-9a-z-]{0,80}\.v2\.json"
)
...
def _candidate_evidence(
    *,
    ...
    if observed_entry != entries[0] or identity.get("schema") != RUNTIME_SCHEMA_V4:
    ...
    if (
        ...
        or entries[0].get("receipt_sha256") != EXPECTED_CANDIDATE_RECEIPT_SHA256
...
def _vscode_evidence(
    *,
    ...
    journal_path = server_root.parent / (
        f".ea-capacity-vscode-{recovery_token}.journal.v2.json"
    )
    complete_path = server_root.parent / (
        f".ea-capacity-vscode-{recovery_token}.complete.v2.json"
    )
...
def _validate_plan(plan: dict[str, object], *, producer_sha256: str) -> None:
    ...
    if (
        ...
        or candidate.get("receipt_sha256") != EXPECTED_CANDIDATE_RECEIPT_SHA256
        or not isinstance(vscode, dict)
