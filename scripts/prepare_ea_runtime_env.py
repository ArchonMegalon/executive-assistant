...
SERVICE_SCOPED_TRANSPORT_KEYS = frozenset(
    {
        b"ONEMIN_DIRECT_API_PROXY_POOL",
        b"ONEMIN_DIRECT_API_PROXY_SERVER",
    }
)
...
BLOCKED_EXACT_KEYS = (
    REGISTRATION_MAIL_KEYS | GOOGLE_IDENTITY_KEYS | SERVICE_SCOPED_TRANSPORT_KEYS
)
