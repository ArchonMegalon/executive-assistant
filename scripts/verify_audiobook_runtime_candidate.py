...
def _validate_supporting_provenance(
    ...
    *,
    ...
    if schema != "ea.manfred_memorial_image_build.v2":
    ...
    return {
        "provided": True,
        "validated": not issues,
        # The available v2 receipt is private and atomic but is neither a generic
        ...
        "schema": schema if schema == "ea.manfred_memorial_image_build.v2" else "unrecognized",
    }, issues
