...
- The intended Chummer6 guide workflow is staged: `chummer6_public_writer` -> `chummer6_public_auditor` -> `chummer6_visual_director` -> `chummer6_scene_auditor` -> render -> `chummer6_visual_auditor` -> `chummer6_pack_auditor`.
