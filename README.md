...
The verifier also reports whether private stage packets and safe-work results are enabled, writable, buildable, and carrying the expected safe-work contracts for the current actionable digest. It now surfaces a separate context-grounding line too, covering how many candidate assessments, grounded preferences, grounded requirements, and deadlines were attached to the actionable digest. When proactive OODA is enabled, the private artifact checks are release-blocking.
