...
| GET | `/v1/human/tasks/priority-summary` | `200` | validation `422`, `403 principal_scope_mismatch` (supports `status`, `role_required`, `operator_id`, `assigned_operator_id`, `assignment_state`, and `overdue_only`) |
