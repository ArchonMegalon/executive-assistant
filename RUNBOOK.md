...
| GET | `/v1/human/tasks` | `200` | validation `422`, `403 principal_scope_mismatch` (supports `role_required`, `assigned_operator_id`, `assignment_state`, `overdue_only`, and `sort=created_asc|created_desc|last_transition_desc|sla_due_at_asc|sla_due_at_asc_last_transition_desc`) |
| GET | `/v1/human/tasks/backlog` | `200` | validation `422` (supports `assignment_state` and `sort=created_asc|created_desc|last_transition_desc|sla_due_at_asc|sla_due_at_asc_last_transition_desc`) |
| GET | `/v1/human/tasks/unassigned` | `200` | validation `422` (supports `sort=created_asc|created_desc|last_transition_desc|sla_due_at_asc|sla_due_at_asc_last_transition_desc`) |
| GET | `/v1/human/tasks/mine` | `200` | validation `422` (supports `sort=created_asc|created_desc|last_transition_desc|sla_due_at_asc|sla_due_at_asc_last_transition_desc`) |
