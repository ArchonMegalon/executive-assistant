...
verify-ltd-operating-mesh:
	...
	$(PYTHON_BIN) scripts/materialize_ltd_proof_debt.py --check
...
verify-ltd-rafter-pixefy:
	$(PYTHON_BIN) scripts/verify_ltds_rafter_pixefy_entries.py
