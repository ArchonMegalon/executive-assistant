...
Expected usage:
- copy one or more `*.ovpn` files from your FastestVPN manual/OpenVPN download set into this directory, or run `scripts/bootstrap_fastestvpn_configs.sh` from the repo root.
