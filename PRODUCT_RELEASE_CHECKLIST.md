...
- the whole-project gold map is materialized, consumes passing external Chummer receipts, and still blocks whole-Chummer gold unless memorial voice/realtime has its own passing receipt.
