...
class CandidateRegistryTests(unittest.TestCase):
    ...
    def test_v4_registration_requires_commit_bound_compose_attestation(self) -> None:
    ...
    def test_v4_registration_requires_exact_execution_input_seals(self) -> None:
        payload = self._runtime_payload()
    ...
    def test_v4_registration_requires_immutable_image_id_semantics(self) -> None:
        payload = self._runtime_payload()
    ...
    def test_v4_registration_requires_exact_runtime_api_posture(self) -> None:
        payload = self._runtime_payload()
    ...
    def test_pending_to_v4_registration_is_atomic_private_and_idempotent(self) -> None:
        receipt = self.receipts / "candidate-v4.json"
    ...
    def test_new_legacy_v3_registration_is_forbidden(self) -> None:
        receipt, _digest = self._write_json(
            self.receipts / "candidate-v3.json",
            self._runtime_payload(schema=RUNTIME_SCHEMA_V3),
        )
        with self.assertRaisesRegex(
            RuntimeError,
    ...
    def test_v4_container_identity_drift_is_rejected(self) -> None:
        payload = self._runtime_payload()
    ...
    def test_v4_revision_disagreement_is_rejected(self) -> None:
        payload = self._runtime_payload()
