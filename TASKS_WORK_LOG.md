...
| Q-127 | P0 | Continue Milestone 5 memory layer (`authority_bindings` seed table + API stubs + principal scoping) | codex | queued | Chain after commitments slice commit |
